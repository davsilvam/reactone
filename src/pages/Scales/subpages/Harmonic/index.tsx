...
export const Harmonic: React.FC = () => {
    ...
    <Container>
      ...
      <Navigation>
        ...
        <div>
          ...
          <Chevron />
          <Link to="/scales/harmonic">Harmônicas</Link>
        </div>
      </Navigation>

      <div>
        <div>
          <h1>Escalas Harmônicas</h1>
          <p>
            As escalas harmônicas são formadas por 7 notas, diminuindo meio tom
            da 6ª das escalas maiores e aumentando a 7ª para as menores.
          </p>
        </div>
